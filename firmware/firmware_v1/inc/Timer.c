...
void TimerG0_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[4] = (NVIC->IP[4] & (~0x000000FF)) |
                (priority << 6); // set priority (bits 7,6) IRQ 16
...
void TimerG8_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[0] = (NVIC->IP[0] & (~0x00FF0000)) |
                (priority << 22); // set priority (bits 23,22) IRQ 2
...
void TimerA0_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[4] = (NVIC->IP[4] & (~0x00FF0000)) |
                (priority << 22); // set priority (bits 23,22) IRQ 18
...
void TimerA1_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[4] = (NVIC->IP[4] & (~0xFF000000)) |
                (priority << 30); // set priority (bits 31,30) IRQ 19
...
void TimerG7_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[5] = (NVIC->IP[5] & (~0x000000FF)) |
                (priority << 6); // set priority (bits 7,6) IRQ 20
...
void TimerG6_IntArm(uint16_t period, uint32_t prescale, uint32_t priority) {
  ...
  NVIC->IP[4] = (NVIC->IP[4] & (~0x0000FF00)) |
                (priority << 14); // set priority (bits 15,14) IRQ 17
...
void TimerG12_IntArm(uint32_t period, uint32_t priority) {
  ...
  NVIC->IP[5] = (NVIC->IP[5] & (~0x0000FF00)) |
                (priority << 14); // set priority (bits 15,14) IRQ 21
